...
const DeckAnalysis = () => {
    ...
    const analyze = () => {
        ...
        points.push(
            `Curve: ${lowCount} low, ${midCount} mid, ${highCount} high`
        );
        ...
        if (avgAttack >= 7) points.push("High avg attack — trades & burst");
            ...
            points.push("Moderate attack — versatile trades");
        else points.push("Low attack — likely spell/combo reliant");

        // health profile
        if (avgHealth >= 7)
            points.push("High health — minions survive removal");
        else if (avgHealth >= 4)
        ...
        if (midCount / count > 0.4)
            points.push("Midrange heavy — very adaptable");
